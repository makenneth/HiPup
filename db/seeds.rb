...
User.create({owner_name: "Sample User", email: "whisker@example.com", lat: city1.lat, lng: city1.lng, 
	name: "Whisker", password: Faker::Internet.password(8), username: "sampleuser", city: city1.city, 
...
4.times do |z|
	Group.create({title: cities[z].city + " Frisbee Group", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1, image_url: "/dog-frisbee1.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 1 + z * 10, tag_id: 3})
	Group.create({title: cities[z].city + " Manicure Group", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1, image_url: "/dog-manicure.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 2 + z * 10, tag_id: 4})
	Group.create({title: cities[z].city + " Soccer Competition", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1, image_url: "/dog-soccer.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 3 + z * 10, tag_id: 5})
	Group.create({title: cities[z].city + " Obstacle Course Training", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1, image_url: "/dog-obstacle.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 4 + z * 10, tag_id: 9})
	Group.create({title: cities[z].city + " Hiking", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1, image_url: "/dog-hiking.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 5 + z * 10, tag_id: 13})
	Group.create({title: cities[z].city + " Surfing", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1, image_url: "/dog-surfing3.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 6 + z * 10, tag_id: 7})
	Group.create({title: cities[z].city + " Group Massage", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1, image_url: "/dog-massage.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 7 + z * 10, tag_id: 2})
	Group.create({title: cities[z].city + " Yarnball playdate", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1 + 40, image_url: "/cat-yarnball.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 8 + z * 10, tag_id: 8})
	Group.create({title: cities[z].city + " Hide-N-seek", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1 + 40, image_url: "/cat-hidenseek.jpg", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 9 + z * 10, tag_id: 11})
	Group.create({title: cities[z].city + " Sun Bathe", description: Faker::Lorem.paragraphs(3).join("\n"), lat: cities[z].lat, lng: cities[z].lng, creator_id: rand(10) + 1 + 40, image_url: "/cat-sunbathe-3", city: cities[z].city, state: cities[z].state })
	Tagging.create({group_id: 10 + z * 10, tag_id: 12})
end
4.times do |z|
	((1 + z * 10)..(7 + z * 10)).each do |i|
		group = Group.find(i)
		GroupParticipant.create({participant_id: group.host_id, group_id: i}) #should join the user in the controller

		participants = []
		6.times do 
			participant = i % 10 < 8 ? rand(10) + 10 * z + 1 : rand(10) + 41 + 10 * z
			next if participants.include?(participant) || participant == group.host_id 
